...
var Validar = /** @class */ (function () {
    function Validar() {
    }
    Validar.checkNumero = function (dato) {
        var numero;
        try { //TODA LA FUNCION ESTA DENTRO DE UN BLOQUE TRY/CATCH
            if (dato === '') { //PRIMER CONTROL: QUE NO SEA VACIO
                ...
                for (var i = 0; i < dato.length; i++) { //SI NO ES VACIO LE EJECUTO PARSEINT UNO POR UNO O SEA CIFRA POR CIFRA O LETRA POR LETRA
