...
try {
    var opcion = RLS.question('Ingrese una opcion, C para registrar un auto, R para buscar un auto, U para actualizar datos de un auto y D para eliminar un auto del registro,  X para finalizar: ').toUpperCase();
